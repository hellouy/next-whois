...
[Project Knowledge Summary]
- Date: 2026-09-13
- Context: Discovered while fixing false "已释放/now available" notification for f.sb (registry hold, date-based dropped estimate misfire) — final fix shipped as commit 1e2e4a6
- Category: Troubleshooting & Debugging
- Instructions:
