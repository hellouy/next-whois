  ...
  return (
    <>
      ...
      <div className="md:hidden min-h-screen flex flex-col">
        {/* Top header */}
        <header className="sticky top-0 z-40 bg-background/95 backdrop-blur-md border-b border-border px-3 sm:px-4 h-14 flex items-center gap-2 sm:gap-3">
          ...
          >
            ...
            <span className="hidden min-[390px]:inline">{t("admin.frontend")}</span>
          </button>
          <button
            ...
            {BOTTOM_PINNED.map(({ href, labelKey, icon: Icon, activeIcon: ActiveIcon, exact }) => {
              ...
              return (
                <button
                  ...
                  onClick={() => navigate(href)}
                  className={cn(
                    "min-w-0 flex-1 flex flex-col items-center justify-center gap-1 transition-colors px-0.5",
