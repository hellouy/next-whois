...
const FEATURES_EN: Array<[string, string, string]> = [
  ...
  ["", "Brand Claims", "Certify ownership with a verified tag on your domain"],
...
const FEATURES_DE: Array<[string, string, string]> = [
  ...
  ["", "Marken-Claims", "Zertifizieren Sie Ihre Domain mit einem verifizierten Badge"],
...
const FEATURES_RU: Array<[string, string, string]> = [
  ...
  ["", "Брендинг домена", "Подтвердите право собственности на домен"],
...
const FEATURES_FR: Array<[string, string, string]> = [
  ...
  ["", "Revendication de marque", "Certifiez la propriété de votre domaine"],
...
export const EMAIL_STRINGS: Record<EmailLocale, EmailStrings> = {
  ...
  zh: {
    ...
    subj_reserved: (d: string) => `${d} 当前为保留（Reserved）状态`,
  ...
  "zh-tw": {
    ...
    subj_reserved: (d: string) => `${d} 目前為保留（Reserved）狀態`,
  ...
  en: {
    ...
    subj_reserved: (d: string) => `${d} is Reserved`,
  ...
  de: {
    ...
    subj_reserved: (d: string) => `${d} ist reserviert`,
  ...
  ru: {
    ...
    subj_reserved: (d: string) => `${d} зарезервирован (Reserved)`,
  ...
  ja: {
    ...
    subj_reserved: (d: string) => `${d} は予約状態です`,
  ...
  fr: {
    ...
    subj_reserved: (d: string) => `${d} est réservé`,
  ...
  ko: {
    ...
    subj_reserved: (d: string) => `${d}이(가) 예약 상태입니다`,
