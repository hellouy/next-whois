/**
 * Static RDAP bootstrap for gTLDs, ccTLDs, and IDN TLDs.
 * Includes all IANA-registered RDAP TLDs plus manually-verified extras.
 * Source: https://data.iana.org/rdap/dns.json
 * IANA Published: 2026-03-23T19:00:02Z
 * Updated: 2026-04-01
 * Entries: 1223
 *
 * Extra (not in IANA but verified working):
 *   ag, bz, io, lc, mn, vc — Identity Digital ccTLDs
 *   xn--* IDN overrides — see CCTLD_RDAP_OVERRIDES in rdap_client.ts
 *
 * To regenerate from IANA: node scripts/update-rdap-bootstrap.js
 */
export const GTLD_RDAP_BOOTSTRAP: Record<string, string> = {
  ...
  "xn--fzc2c9e2c": "https://rdap.nic.lk/",
  ...
  "xn--xkc2dl3a5ee0h": "https://rdap.nic.lk/",
  "xn--y9a3aq": "https://rdap.nic.am/",
...
/** Look up the RDAP base URL for a given TLD (returns undefined if not known). */
