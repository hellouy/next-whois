...
const AI_PROVIDERS = [
  ...
  { id: "groq",        name: "Groq",               desc: "Llama-3.3-70B / Gemma2-9B",     link: "https://console.groq.com/keys",           color: "bg-orange-100 dark:bg-orange-950/40 text-orange-600 dark:text-orange-400", priority: 4 },
