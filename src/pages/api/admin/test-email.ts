  ...
  return [
    ...
    },
    {
      ...
      html: subscriptionConfirmHtml({
        ...
        expiresAt: expDate.toLocaleDateString("zh-CN"),
    ...
    },
    {
      ...
      html: phaseEventHtml({
        domain: SAMPLE_DOMAIN,
        phase: "grace",
        expiresAt: now.toLocaleDateString("zh-CN"),
        phaseEndsAt: new Date(now.getTime() + 45 * 86400 * 1000).toLocaleDateString("zh-CN"),
        siteName,
        locale: SAMPLE_LOCALE,
      }),
    },
    {
      ...
      html: phaseEventHtml({
        ...
        phase: "redemption",
        expiresAt: now.toLocaleDateString("zh-CN"),
        phaseEndsAt: new Date(now.getTime() + 30 * 86400 * 1000).toLocaleDateString("zh-CN"),
        siteName,
        locale: SAMPLE_LOCALE,
      }),
    },
    {
      ...
      html: phaseEventHtml({
        ...
        phase: "pendingDelete",
        expiresAt: now.toLocaleDateString("zh-CN"),
        phaseEndsAt: new Date(now.getTime() + 5 * 86400 * 1000).toLocaleDateString("zh-CN"),
        siteName,
        locale: SAMPLE_LOCALE,
      }),
    },
